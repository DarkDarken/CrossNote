...
public class RecyclerItemPrViewTouchHelper extends RecyclerItemBaseTouchHelper {

    private RecyclerItemMainTouchHelper.RecyclerItemTouchHelperListenerOnSwipe listenerOnSwipe;

    public RecyclerItemPrViewTouchHelper(int dragDirs, int swipeDirs, RecyclerItemMainTouchHelper.RecyclerItemTouchHelperListenerOnSwipe listenerOnSwipe) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((RecyclerPrViewListAdapter.MyViewHolder) viewHolder).viewForeground;
            final View backgroundView = ((RecyclerPrViewListAdapter.MyViewHolder) viewHolder).viewBackground;
            final View delL = ((RecyclerPrViewListAdapter.MyViewHolder) viewHolder).del_L;
            final View delR = ((RecyclerPrViewListAdapter.MyViewHolder) viewHolder).del_R;
